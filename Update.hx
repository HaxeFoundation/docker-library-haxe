...
#';
	...
	static public var versions:Array<Version> = [
		{
			...
			"win64": true,
			"nekowin64": true,
			"sha256": {"win": "8f77bf1dc3fae88b3174e311c60e69ab25c02093a0801bd3e49b28609f465e1e"},
			"exclude": [],
			"opam": true,
			"pcre2": true,
		},
		...
		},
		{
			...
			"exclude": ["alpine3.15", "alpine3.16", "alpine3.17", "bullseye"],
			"opam": false
		},
		{
			"version": "3.3.0-rc.1",
		...
		},
		{
			...
			"exclude": ["alpine3.15", "alpine3.16", "alpine3.17", "buster", "bullseye"],
			"opam": false
		},
	];
	...
	static public var variants = [
		...
		Alpine => ["alpine3.17", "alpine3.16", "alpine3.15"],
	];
