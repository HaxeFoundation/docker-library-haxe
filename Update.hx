...
#';
	...
	static public final versions:Array<HaxeVersion> = [
		{
			...
			"winNeko": neko.v2_4_1,
			"opamPins": [
				{"lib": "luv", "version": "0.5.14", "variants":["alpine3.21", "alpine3.22"], "ignoreConstraints": true},
			],
		},
		{
		...
		},
		{
			...
			"exclude": ["alpine3.21", "alpine3.22"],
			"pcre2": false,
			"winNeko": neko.v2_3_0,
			"opamPins": [
				{"lib": "extlib", "version": "1.7.9"},
				{"lib": "camlp5", "version": "8.03.04", "variants":["alpine3.19", "alpine3.20", "alpine3.21", "alpine3.22"], "ignoreConstraints": true},
		...
		},
		{
			...
			"exclude": ["bookworm", "alpine3.21", "alpine3.22"],
			"pcre2": false,
			"winNeko": neko.v2_3_0,
			"opamPins": [
				{"lib": "extlib", "version": "1.7.7"},
				{"lib": "camlp5", "version": "8.03.04", "variants":["alpine3.19", "alpine3.20", "alpine3.21", "alpine3.22"]},
	...
	static public final variants = [
		...
		Alpine => ["alpine3.22", "alpine3.21", "alpine3.20", "alpine3.19"],
	];
