...
#';
	...
	static public final versions:Array<HaxeVersion> = [
		...
		},
		{
			...
			"opamPins": [
				...
				{"lib": "camlp5", "version": "8.03.04", "variants":["alpine3.20", "alpine3.21", "alpine3.22"], "ignoreConstraints": true},
		...
		},
		{
			...
			"opamPins": [
				...
				{"lib": "camlp5", "version": "8.03.04", "variants":["alpine3.20", "alpine3.21", "alpine3.22"]},
	...
	static public final variants = [
		...
		Alpine => ["alpine3.22", "alpine3.21", "alpine3.20"],
	];
